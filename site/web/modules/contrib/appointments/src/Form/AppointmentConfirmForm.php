...
/**
 * Class AppointmentConfirmForm.
 */
class AppointmentConfirmForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a AppointmentConfirmForm object.
   *
  ...
  public function getFormId() {
    return 'appointments_confirm_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($this->appointmentsTransactionManager->canTransitionToConfirm($this->appointment)) {
      $this->appointmentsManager->confirm($this->appointment);
      $this->messenger->addMessage("Configuration updated");
    }
    else {
      $this->messenger->addMessage("You can not put Appointment in Confirmed state");
    }
  ...
  public function getQuestion() {
    return t('Do you want to confirm Appointment %id?', ['%id' => $this->appointment->id()]);
  }
